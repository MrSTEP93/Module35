...
namespace UnsocNetwork.Migrations
{
    ...
    [Migration("20240920122759_Adding_Messages")]
    partial class Adding_Messages
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UnsocNetwork.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UnsocNetwork.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UnsocNetwork.Models.Message", b =>
                {
                    b.HasOne("UnsocNetwork.Models.User", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("UnsocNetwork.Models.User", "Sender")
                        .WithMany()
